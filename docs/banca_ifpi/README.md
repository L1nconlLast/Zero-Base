# Zero Base — Versão Enxuta para Banca IFPI

Este conjunto organiza a apresentação acadêmica do projeto em formato objetivo, com foco em método, validação e evidências.

## Estrutura sugerida (ordem de apresentação)
1. [01_RESUMO_EXECUTIVO.md](01_RESUMO_EXECUTIVO.md)
2. [02_PROBLEMA_OBJETIVOS.md](02_PROBLEMA_OBJETIVOS.md)
3. [03_METODOLOGIA_DESENVOLVIMENTO.md](03_METODOLOGIA_DESENVOLVIMENTO.md)
...
- Cada resultado deve ter evidência técnica associada.
- Métricas devem indicar método de medição.
- Foco no que foi implementado e validado.
