...
import { CheckCircle, XCircle, ChevronRight, RotateCcw, Filter, Zap, Trophy } from 'lucide-react';
    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="text-center">
          <h2 className="text-2xl font-semibold text-slate-900 dark:text-slate-100">🧠 Banco de Questões</h2>
          ...
          {dailyMode && (
            <div className="grid grid-cols-2 gap-3 mb-6">
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-3">
                <p className="text-xl font-bold text-amber-600">🔥 {dailyStreak}</p>
